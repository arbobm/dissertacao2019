...
output:
  bookdown::pdf_book:
    ...
    includes:
      in_header: templates/preample.tex
  bookdown::gitbook:
    config:
      sharing:
        facebook: false
...
```{r areaestudo, fig.cap = "Área de estudo abordada no diagnóstico de pressão ambiental no bioma Pampa. Fisionomias campestres: CArb = Campo Arbustivo; CAre = Campo com Areais; CBDB = Campo com Barba-de-Bode; CEsp = Campo com Espinilho; CSR = Campo com Solos Rasos; CGra = Campo Graminoso; CMAC = Campo Misto com Andropogôneas e Compostas; CMCO = Campo Misto do Cristalino Oriental; FE = Floresta Estacional.", fig.height=10, fig.width=15, out.extra = ""}
```
