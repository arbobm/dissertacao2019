...
## @knitr dados
dados <- data.frame(read.csv("C:/SIG/laboratorio/01_mestrado/dissertacao2019/tabelas/02_dados.csv"))
knitr::kable(dados,
             format="latex",
             booktabs = T,
             escape = F,
...
knitr::kable(cenariospesos,
  ...
  kableExtra::kable_styling(bootstrap_option = c("condensed"),
                            ...
                            position = "center",
                            font_size = 10) %>%
  kableExtra::column_spec(1, bold = F, border_right = F, width = "3.30cm") %>%
...
knitr::kable(atributosfuncionais,
             ...
             booktabs = T,
             escape = F,
             caption = 'Treze atributos funcionais indicadores de uso/ocupação do habitat e comportamento alimentar. Ver Figura \\ref{fig:medidas} para abreviações.',
...
knitr::kable(variaveisambientais,
  ...
  kableExtra::column_spec(3, bold = F, border_right = F, width = "2.00cm") %>%
  kableExtra::column_spec(4, bold = F, border_right = F, width = "2.00cm") %>%
  kableExtra::column_spec(5, bold = F, border_right = F, width = "2.00cm") %>%
  kableExtra::column_spec(6, bold = F, border_right = F, width = "2.00cm") %>%
  kableExtra::column_spec(7, bold = F, border_right = F, width = "2.00cm")
...
knitr::kable(baciasresults,
  ...
  kableExtra::kable_styling(bootstrap_option = c("condensed"),
                            ...
                            position = "center",
                            font_size = 10) %>%
  kableExtra::footnote(general = "MDC = Condição de distúrbio mínimo; LDC = Condição de menor distúrbio; 
           CArb = Campo Arbustivo; CAre = Campo com Areais; CBDB = Campo com Barba-de-Bode; 
           CEsp = Campo com Espinilho; CSR = Campo com Solos Rasos; 
           CGra = Campo Graminoso; CMAC = Campo Misto com Andropogôneas e Compostas; 
           CMCO = Campo Misto do Cristalino Oriental; FE = Floresta Estacional.",
                       threeparttable = T) %>%
  kableExtra::column_spec(1, bold = F, border_right = F, width = "3.80cm") %>%
...
knitr::kable(caractbaciarefcenarios,
  ...
  kableExtra::kable_styling(bootstrap_option = c("condensed"),
                            ...
                            position = "center",
                            font_size = 10) %>%
  kableExtra::footnote(general = "SR = Subunidade regional; Agr = Agricultura (%); 
                       Via = Rede Viária (km/km^2^); EA = Espelhos d'água < 20 ha; 
                       Min = Mineração (%); Gado = Número de cabeças/km^2^; Urb = Área Urbana (%); 
                       FE = Floresta Estacional - Patos; CArbP = Campo Arbustivo - Patos.",
                       threeparttable = T) %>%
  kableExtra::column_spec(1, bold = F, border_right = F, width = "1.00cm") %>%
...
knitr::kable(pRDAcomptax,
  ...
  kableExtra::kable_styling(bootstrap_option = c("condensed"),
                            ...
                            position = "center",
                            font_size = 10) %>%
  kableExtra::column_spec(1, bold = F, border_right = F, width = "6.00cm") %>%
...
knitr::kable(correlindipRDA,
             ...
             booktabs = T,
             escape = F,
             caption = "Correlações dos indicadores de pressão nos primeiros eixos da análise de redundância parcial (pRDA) e escores ajustados das espécies com os 10 maiores escores nos dois primeiros eixos.",
  ...
  kableExtra::kable_styling(bootstrap_option = c("condensed"),
                            ...
                            position = "center",
                            font_size = 10) %>%
  kableExtra::column_spec(1, bold = F, border_right = F, width = "2.85cm") %>%
  kableExtra::column_spec(2, bold = F, border_right = F, width = "4.40cm") %>%
  kableExtra::column_spec(3, bold = F, border_right = F, width = "2.85cm") %>%
